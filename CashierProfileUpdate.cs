...
namespace PMS.View
{
    public partial class CashierProfileUpdate : Form
    {
        public CashierProfileUpdate()
        {
            InitializeComponent();
        }
        ...
        private void CashierProfileUpdate_Load(object sender, EventArgs e)
        {
            LoadProfileData();
        }
        ...
        {
            CashierProfile a = new CashierProfile();
            a.Show();
            this.Hide();
        }

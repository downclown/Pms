...
namespace PMS.View
{
    public partial class AdminDashboard : Form
    {
        ...
        private void LoadUserCounts()
        {
            ...
            lbl_invman_count.Text = GetUserCountByType("Inventory Manager").ToString();
        }
        ...
        {
            AdminViewReport q = new AdminViewReport();
            q.Show();
            this.Hide();
        }
        ...
        private void lbl_admin_count_Click(object sender, EventArgs e)
        {

...
namespace PMS.View
{
    public partial class PharmaUpdateProfile : Form
    {
        public PharmaUpdateProfile()
        {
            InitializeComponent();
        }
        ...
        private void PharmaUpdateProfile_Load(object sender, EventArgs e)
        {
            LoadProfileData();
        }
        ...
        {
            PharmaProfile q = new PharmaProfile();
            q.Show();
            this.Hide();
        }

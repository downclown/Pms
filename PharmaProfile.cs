...
namespace PMS.View
{
    public partial class PharmaProfile : Form
    {
        ...
        {
            PharmacistDashboard a = new PharmacistDashboard();
            a.Show();
            this.Hide();
        }
        ...
        private void PharmaProfile_Load(object sender, EventArgs e)
        {
            LoadProfileData();
        ...
        {
            PharmaUpdateProfile a = new PharmaUpdateProfile();
            a.Show();
            this.Hide();
        }
    }
